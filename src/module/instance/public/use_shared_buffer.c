...
void ddns_Instance_useSharedBuffer(
	...
	if (napc_streqli(label, "4k-buffer-1")) {
		buffer_ptr = instance->buffer_4k_1;
		buffer_size = sizeof(instance->buffer_4k_1);
		buffer_busy_var = &instance->buffer_4k_1_busy;
	} else if (napc_streqli(label, "4k-buffer-2")) {
		buffer_ptr = instance->buffer_4k_2;
		buffer_size = sizeof(instance->buffer_4k_2);
		buffer_busy_var = &instance->buffer_4k_2_busy;
	}
